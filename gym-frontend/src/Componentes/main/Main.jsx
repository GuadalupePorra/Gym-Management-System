...
import kickImg from '../../assets/kick.jpg';
    ...
    <div className="main"> 
            <div className="insc_clases"> 
                <div className="text-center my-3" > 
                    <button type="button" className="btn btn-dark btn-lg px-2" onClick={handleButtonClick} id="inscrpcion" > 
                        Ingreso socios 
                    </button> 
                </div>
            </div> 
            <div className="clases" id="clases"> 
                ...
                <div className="slider-container">
                    <div className="slider-track">  {[...Array(2)].map((_, i) => ( <React.Fragment key={i}> 
                        ...
                        <div className="card-custom"> 
                            <img src={kickImg} alt="Kick Boxing" /> 
                            <h5>Kick Boxing</h5> 
                            <p>
                        ...
                        <div className="card-custom"> 
                            <img src={spinningImg} alt="Spinning" /> 
                            <h5>Spinning</h5> 
                            <p>
